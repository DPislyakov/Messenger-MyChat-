...
class SignUpViewController: UIViewController {
    ...
    let emailTextField = OneLineTextFiled(font: .avenir20())
    let passwordTextField = OneLineTextFiled(font: .avenir20())
    let confirmPasswordTextField = OneLineTextFiled(font: .avenir20())
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(red: 176/255, green: 245/255, blue: 241/255, alpha: 1)
        setupConstraints()
